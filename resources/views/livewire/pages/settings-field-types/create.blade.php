...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        SettingsFieldType::create($validated);
...
<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">{{ __('Create Field Type') }}</flux:heading>
        <flux:subheading>{{ __('Add a new field type') }}</flux:subheading>
    </div>
