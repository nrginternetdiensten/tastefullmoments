...
new class extends Component {
    ...
    {
        // Auto-generate seo_url from name if seo_url is empty
        if (empty($this->seo_url)) {
            $this->seo_url = Str::slug($this->name);
        }
...
<div class="mx-auto max-w-4xl space-y-6">
    <div>
        <flux:heading size="xl">{{ __('Create Blog Category') }}</flux:heading>
        <flux:subheading>{{ __('Add a new blog category') }}</flux:subheading>
    </div>
