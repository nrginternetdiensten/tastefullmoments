...
new class extends Component {
    ...
    public function mount(AccountTransaction $transaction): void
    {
        $this->transaction = $transaction;
        $this->account_id = $transaction->account_id;
        $this->type = $transaction->type;
        $this->amount_cents = number_format($transaction->amount_cents / 100, 2, '.', '');
...
<div class="space-y-6">
    <div>
        ...
        <flux:subheading>{{ __('Update transaction details') }}</flux:subheading>
    </div>
