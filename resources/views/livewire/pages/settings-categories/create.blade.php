...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        SettingsCategory::create($validated);
...
<div class="mx-auto max-w-2xl space-y-6">
    <div>
        <flux:heading size="xl">{{ __('Create Settings Category') }}</flux:heading>
        <flux:subheading>{{ __('Add a new settings category') }}</flux:subheading>
    </div>
