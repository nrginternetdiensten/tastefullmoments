        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
            <div class="text-center max-w-3xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('frontend.about') }}" wire:navigate class="px-8 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">
                        Ontdek meer
                    </a>
                    <a href="{{ route('frontend.contact') }}" wire:navigate class="px-8 py-3 bg-white border-2 border-blue-600 text-blue-600 rounded-lg font-medium hover:bg-blue-50 transition-colors">
                        Neem contact op
                    </a>
                </div>
            </div>
    ...
    <section class="bg-zinc-100 dark:bg-zinc-900 py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto">
                ...
                <a href="{{ route('frontend.contact') }}" wire:navigate class="inline-block px-8 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">
                    Contact opnemen
                </a>
            </div>
        </div>
